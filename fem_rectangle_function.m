function [d, sigmas] = fem_rectangle_function(x_hanger, w, M)
    %% Constants
    ...
    n=2*k+2;          % The number of nodes while using rectangle elements
    D=E/(1-v^2)*[1 v 0; 
                 v 1 0; 
    ...
    for element_index=1:k
        ...
        sigmas(:,element_index)=subs(sigma, [r, s], [-1, -1]);
    end
end